...
namespace ai
{
    ...
    class UseItemHearthStone : public Action {
    public:
        UseItemHearthStone(PlayerbotAI* ai, string name = "use", bool selfOnly = false) : Action(ai, name), selfOnly(selfOnly) {}
    ...
    class UseHearthStone : public UseItemHearthStone {
    public:
        UseHearthStone(PlayerbotAI* ai, string name, bool selfOnly = false) : UseItemHearthStone(ai, name, selfOnly) {}
