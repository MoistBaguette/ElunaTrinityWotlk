...
namespace ahbot
{
    ...
    private:
        ...
        int AddAuctions(int auction, Category* category, ItemBag* inAuctionItems, uint8 quality = 1, uint32 numbers = 40);
        int AddAuction(int auction, Category* category, const ItemTemplate* proto, SQLTransaction& transItem);
